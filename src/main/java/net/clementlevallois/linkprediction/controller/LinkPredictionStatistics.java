 ...
 * iteration, a new situation is assumed and the next edge is calculated on the
 * basis of this new, expanded network.
 * <p>
 ...
 */
public abstract class LinkPredictionStatistics {

    /**
     * Default number of iteration used to predict next edges
     */
    public static final int ITERATION_LIMIT_DEFAULT = 5;
    /**
    ...
    /**
     * Recalculates link prediction probability for nodes, affected by last
     * prediction.
     *
     * @param factory Factory to create new edge
     */
